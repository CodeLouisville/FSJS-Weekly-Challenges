...
function Box(width, height, volume) {
  this.width = width;
  this.height = height;
  this.volume = volume;
}
Box.prototype.displayBox = function () {
   var myBox = "I am a box.<br />" +
         "My height is " + this.height + ".<br />" +
         "My weight is " + this.width + ".<br />" +
         "My volume is " + this.volume + ".<br />";
         return myBox;
};
Box.prototype.morph = function (objType, rate) {
   this[objType] = this[objType] + rate
};
